                    ...
                    <?php else: ?>
                        <?php foreach ($points as $point): ?>
                            <tr>
                                ...
                                <td class="pe-4">
                                    <a type="button" class="btn btn-outline-primary ms-2" href="../defects/defects_view.php?point_id=<?= $point['id'] ?>">Подробнее</a>
                                    <?php if (isset($_SESSION['user_info']) && !empty($_SESSION['user_info'])): ?>
                                        ...
                                        class="btn btn-outline-secondary  ms-2">Изменить</a>
