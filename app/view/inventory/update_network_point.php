                ...
                <div class="card border">
                    <div class="card-body p-4">
                        ...
                        <form action="../../../controllers/inventory/update_network_point.php" method="post"
                            ...
                            <!--                                    <img src="../../public/storage/network_points/-->
                            <?php //echo htmlspecialchars($networkPointInfo['image_name']); ?><!--"-->
                            <!--                                         alt="Изображение сетевой точки -->
                            <?php //echo htmlspecialchars($networkPointInfo['label']); ?><!--">-->
                            <!--                                </div>-->
                            <!--                            --><?php //endif; ?>
                            <!--                            <div class="mb-3">-->
                            <!--                                <label class="form-label">Новая фотография сетевой точки</label>-->
