        ...
        <div class="col-md-8 col-lg-6">
            <div class="card border-secondary-subtle bg-white shadow-sm">
                <div class="card-body p-4">
                    ...
                    <form method="post" action="../../controllers/insertMaterials.php" class="row g-3">
                        <div class="col-12">
                            <label class="form-label small fw-medium text-muted">Название</label>
                            <input type="text" name="name" class="form-control" required placeholder="Введите название материала">
                        </div>
                        <div class="col-12">
