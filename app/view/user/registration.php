...
<div class="d-flex justify-content-center align-items-center flex-column" style="min-height: 70vh; padding: 20px;">
    ...
    <form action="../../../controllers/user/registration.php" method="post"
          class="d-flex flex-column align-items-center" style="max-width: 450px; width: 100%;">
        <h1>Регистрация</h1>
        ...
        <div class="mb-3 w-100 ">
            ...
            <input type="text" name="login" placeholder="Придумайте логин"
                   value="<?php echo htmlspecialchars($_POST['login'] ?? ''); ?>" required maxlength="50"
                   class="form-control" id="exampleFormControlInput1"><br><br>

            <label for="inputPassword5" class="form-label">Пароль</label>
            <input type="password" name="password" placeholder="Придумайте пароль" required maxlength="50"
