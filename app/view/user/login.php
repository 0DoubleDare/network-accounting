...
<div class="d-flex justify-content-center align-items-center flex-column" style="min-height: 70vh; padding: 20px;">
    <form action="../../../controllers/user/auth.php" method="post" class="d-flex flex-column align-items-center"
        ...
        <div class="mb-4 w-100">
            ...
            <input type="password" name="password_hash" id="inputPassword5" class="form-control"
