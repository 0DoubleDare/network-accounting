            ...
            <div class="col-md-6">
                <div class="card border">
                    <div class="card-body p-4">
                        ...
                        <form action="../../controllers/updateNetworkPoint.php" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="image_path" class="form-control"
                                          rows="2"><?php echo $networkPointInfo['image_name']; ?></textarea>
                            </div>
