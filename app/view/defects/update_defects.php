                        ...
                        <form action="../../../controllers/defects/update_defect.php" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" class="form-control" rows="3"
                                          required><?= htmlspecialchars($defect['description'] ?? ''); ?></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="category" class="form-select">
                                    <?php foreach ($categories as $cat): ?>
                                        <option value="<?= $cat['id']; ?>"
                                                <?= $cat['id'] == $defect['category'] ? 'selected' : '' ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="severity" class="form-select">
                                    <option value="low" <?= $defect['severity'] == 'low' ? 'selected' : ''; ?>>Низкая
                                    </option>
                                    <option value="medium" <?= $defect['severity'] == 'medium' ? 'selected' : ''; ?>>
                                        Средняя
                                    </option>
                                    <option value="high" <?= $defect['severity'] == 'high' ? 'selected' : ''; ?>>
                                        Высокая
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-select">
                                    <option value="open" <?= $defect['status'] == 'open' ? 'selected' : ''; ?>>Открыт
                                    </option>
                                    <option value="in_progress" <?= $defect['status'] == 'in_progress' ? 'selected' : ''; ?>>
                                        В работе
                                    </option>
                                    <option value="closed" <?= $defect['status'] == 'closed' ? 'selected' : ''; ?>>
                                        Закрыт
                                    </option>
                                </select>
                            </div>
