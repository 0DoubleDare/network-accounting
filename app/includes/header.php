...
<!--        <a href="--><?php //= $web_root ?><!--public/index.php"><h1 style="color: #333; font-size: 24px; font-weight: 600;">🍵 Network accounting</h1></a>-->
<!--        <nav style="display: flex; gap: 12px;">-->
<!--            <a href="--><?php //= $web_root ?><!--app/view/registration.php"><button type="button" class="btn btn-primary">Регистрация</button></a>-->
<!--            <a href="--><?php //= $web_root ?><!--app/view/login.php"><button type="button" class="btn btn-success">Войти</button></a></a>-->
